package com.royalbimrah.likwik.receivers;
...
import com.royalbimrah.likwik.ui.activities.MainActivity;
...
import com.royalbimrah.likwik.utils.NotificationUtil;
    ...
    private void handleDataMessage(RemoteMessage remoteMessage) {
        ...
        switch (click_action) {
            ...
            case "com.royalbimrah.likwik.TARGET_FRIENDREQUEST":
                ...
                break;
            case "com.royalbimrah.likwik.TARGET_ACCEPTED":

                Log.d("TARGET_ACCEPTED", "onMessageReceived: " + click_action);
                resultIntent = new Intent(getApplicationContext(), FriendProfile.class);

                break;
            case "com.royalbimrah.likwik.TARGET_DECLINED":
